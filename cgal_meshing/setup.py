...
# * name is the full name (e.g., OpenAlea.cgal_meshing) whereas pkg_name is only 'cgal_meshing'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['cgal_meshing = openalea.cgal_meshing_wralea' if has_project else 'cgal_meshing = cgal_meshing_wralea' ],
        #'console_scripts': [
