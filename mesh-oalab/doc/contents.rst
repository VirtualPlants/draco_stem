...
- A `PDF <../latex/mesh.pdf>`_ version of |mesh| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:openalea:mesh:mesh>`__ wiki.
