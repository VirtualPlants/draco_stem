...
OpenAlea.cellcomplex documentation
#########################################################################
...
- A `PDF <../latex/cellcomplex.pdf>`_ version of |cellcomplex| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:openalea:cellcomplex:cellcomplex>`__ wiki.
