...
# * name is the full name (e.g., OpenAlea.cellcomplex) whereas pkg_name is only 'cellcomplex'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['cellcomplex = openalea.cellcomplex_wralea' if has_project else 'cellcomplex = cellcomplex_wralea' ],
        #'console_scripts': [
