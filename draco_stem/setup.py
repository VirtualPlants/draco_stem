...
# * name is the full name (e.g., OpenAlea.draco_stem) whereas pkg_name is only 'draco_stem'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['draco_stem = openalea.draco_stem_wralea' if has_project else 'draco_stem = draco_stem_wralea' ],
        #'console_scripts': [
