...
OpenAlea.draco_stem documentation
#########################################################################
...
- A `PDF <../latex/draco_stem.pdf>`_ version of |draco_stem| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:openalea:draco_stem:draco_stem>`__ wiki.
